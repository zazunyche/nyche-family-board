...
|----|-------|-------------|-------|
| t_propmed1 | Property Medics — send furniture photos to Nathan | 3 | MOM |
| t_propmed2 | Property Medics — confirm floor installation sched | 3 | MOM |
| t_glnrose1 | Glen Rose Drive — review financials | 4 | DAD |
| t_invest01 | Evaluate investment opportunities — ChargeExpress, | 3 | DAD |
| t_redfin01 | Follow up with Redfin agent on Oak Forest CMA — Au | 3 | DAD |
| t_insure01 | Review Acrisure home insurance renewal | 3 | DAD |
| t_suncr001 | Bring labeled sunscreen to AJ's daycare | 3 | BOTH |
| t_0hmz63i | Primrose June prep — sunscreen, summer spare cloth | 4 | BOTH |
| t_6aj3ogq | Property Medics: schedule return visit + send gara | 3 | DAD |
| t_j8zw44t | Board UI — external access via Tailscale or Cloudf | 3 | DAD |
| t_0jf2gam | Audit tasks with start dates before April 2025 — f | 3 | DAD |
| t_15sig01 | 15 Sigourney — follow up with neighbor on repair c | 3 | DAD |
| t_iosapp01 | iOS app for family board — Yaa's plan | 3 | DAD |
| t_wnb2uq9 | Review Primrose July calendar for key dates and cl | 3 | BOTH |
| t_ximvmxa | Book rental car for Chicago (Kojo wedding) | 4 | DAD |
| t_2ol963z | Pantry storage solutions — get dimensions + photo, | 3 | DAD |
